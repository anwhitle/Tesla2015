...
public class Sensors extends Subsystem {
 ...
 Encoder encoder1 = new Encoder(RobotMap.encoder1port1 , RobotMap.encoder1port2, true, EncodingType.k4X);
 Encoder encoder2 = new Encoder(RobotMap.encoder2port1 , RobotMap.encoder2port2, true, EncodingType.k4X);
