...
public class Chassis {
	final VictorSP Vic0 = new VictorSP(RobotMap.VictorDriverFront);	
	final VictorSP Vic1 = new VictorSP(RobotMap.VictorDriverBack);	
	final VictorSP Vic2 = new VictorSP(RobotMap.VictorPassengerFront);	
	final VictorSP Vic3 = new VictorSP(RobotMap.VictorPassengerBack);	
	...
	public void driveMecanum_Cartesinian(double x, double y, double rotation, double gyroAngle){
		mechanumDrive.mecanumDrive_Polar(x, y, rotation);
	}
